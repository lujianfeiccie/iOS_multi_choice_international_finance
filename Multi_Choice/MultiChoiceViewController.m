...
- (void)viewDidLoad
{
    ...
    NSLogExt(@"filename=%@",[super m_filename]);
    
    NSMutableDictionary *dict_none_short_answer= [[NSMutableDictionary alloc] init];
    [dict_none_short_answer setValue:@"4_chapter" forKey:@"4_chapter"];
    [dict_none_short_answer setValue:@"5_chapter" forKey:@"5_chapter"];
    [dict_none_short_answer setValue:@"9_chapter" forKey:@"9_chapter"];
    
    if (nil==[dict_none_short_answer objectForKey:[super m_filename]])
    {
