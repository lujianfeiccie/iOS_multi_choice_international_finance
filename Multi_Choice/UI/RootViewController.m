...
- (void)viewDidLoad
{
    ...
    for (NSInteger i=1; i<=15; i++) {
        ...
        model.m_text =[NSString stringWithFormat:@"第%li章真题",(long)i];
        model.m_value = [NSString stringWithFormat:@"%li_chapter",(long)i];
...
-(void) threadSearch :(NSString*) keywords
{
    ...
    NSMutableArray* mutli_question_filename = [[NSMutableArray alloc]init];
    
    for (NSInteger i=1; i<15; i++)
    {
        [mutli_question_filename addObject:[NSString stringWithFormat:@"%li_chapter",(long)i]];
    }
    [mutli_question_filename addObject:@"2014_04"];
    ...
    NSMutableArray* shortanswer_filename = [[NSMutableArray alloc]init];
    for (NSInteger i=1; i<15; i++) {
        switch (i) {
            case 4:
            case 5:
            ...
            default:
            {
            [shortanswer_filename addObject:[NSString stringWithFormat:@"%li_chapter_short_answer",(long)i]];
            }
                break;
        }
        
    }
    [shortanswer_filename addObject:@"2014_04_short_answer"];
